<template>
        ...
        <div class="navbar-container">
            ...
            <div class="nav-menu">
                ...
                <div class="nav-notif" @click="dropnotif = !dropnotif" :title="$t('hint.notif')">
                    ...
                    <div class="prev-notif" :class="dropnotif ? 'show-notif' : 'hide-notif'" @click="dropnotif = false">
                        ...
                        <div class="content-prev-notif">
                            <div class="main-notif">
                                <div class="main-message">
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dignissimos ducimus recusandae at quibusdam error, incidunt maiores ipsum autem, consectetur aperiam fuga numquam neque eum nihil quas itaque asperiores nulla voluptatem.
                                </div>
                                <div class="main-time">
                                    08:00
                                </div>
            ...
            <div class="menu-profile" :class="dropmenu ? 'swipe-content' : 'swipe-hide'">
                ...
                <div class="submenu-pro">
                    ...
                    <li class="lang-switch">
                        ...
                        <div class="tog-2" @click="toggle(!isDarkmode)">
                            <div class="btn-tog-2" :class="!isDarkmode ? 'tog-rg' : 'tog-lf'"></div>
                        </div>
                    </li>
                    <li class="lang-switch">
                        {{ $t('navMenu.logout') }} 
    ...
    <div :class="dropmenu || dropnotif ? 'close-menu' : 'show-menu'" @click="[dropmenu = false, dropnotif = false ]"></div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const switchLang = () => {
                locale.value === 'id' ? locale.value = 'en' : locale.value = 'en';
                localStorage.setItem('lang', locale.value);
            }

            const switchLang2 = () => {
                locale.value === 'en' ? locale.value = 'id' : locale.value = 'id';
                localStorage.setItem('lang', locale.value);
            }
